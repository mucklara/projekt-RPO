...
function addPoints(language, points) {
    if (languagePoints.hasOwnProperty(language)) {
        ...
        // Now update the points and level in the database
        fetch('/api/leaderboard/update', {
            ...
            body: JSON.stringify({
                userId: 3, // The user's ID (this should come from your session or auth logic)
                languageId: language === "SI" ? 1 : 2, // Assuming 1 = SI and 2 = MKD
