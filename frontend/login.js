...
loginForm.addEventListener('submit', async (event) => {
    ...
    try {
        ...
        if (response.ok) {
          ...
          //  localStorage.setItem('avatar', data.user.avatar || 'default-avatar.png'); // Default avatar if not provided
...
async function loginUser(username, password) {
    try {
       ...
       // localStorage.setItem('avatar', userData.avatar || '/uploads/avatars/default-avatar.png'); // Default avatar if none provided
